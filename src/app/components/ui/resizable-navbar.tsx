...
export const NavbarLogo = () => {
  return (
    <a
      href="#"
      className="relative z-20 mr-4 flex items-center space-x-3 px-2 py-1 text-lg font-bold text-black dark:text-white hover:opacity-80 transition"
    >
      <img src="/img/minerva.png" alt="logo" width={50} height={50} />
      <span className="tracking-wide text-white">My Portofolio</span>
    </a>
  );
};
